...
<body>
    ...
    <div class="portfolio-canvas">
        ...
        <div class="cert-header-area">
            <h1 class="cert-title">Corporate training test<br>Certificate</h1>
            <div class="cert-subtitle">CodeBind technologies • 2026</div>
        </div>

        <div class="cert-image-container">
            <img src="img/c3.jpeg" alt="AWS Solutions Architect Certificate Asset" class="art-image-backdrop">
        </div>

        <div class="cert-description-area">
            <div class="interactive-text-block">
                <h3 class="cert-desc-title">Title: Placement Aptitude Systems Training</h3>
                <div class="cert-desc-authority">Authority: CodeBind Technologies • 2026</div>
                <p class="cert-desc-text">Note: Optimization of algorithmic problem-solving speed, quantitative logic processing, and architectural analytics parsing under constrained testing conditions.</p>
            </div>
        </div>
