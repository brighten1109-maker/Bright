...
<body>
    ...
    <div class="portfolio-canvas">
        ...
        <div class="cert-header-area">
            <h1 class="cert-title">Workshop on AI<br>Certificate</h1>
            <div class="cert-subtitle">CodeBind technologies • 2026</div>
        </div>

        <div class="cert-image-container">
            <img src="img/c4.jpeg" alt="AWS Solutions Architect Certificate Asset" class="art-image-backdrop">
        </div>

        <div class="cert-description-area">
            <div class="interactive-text-block">
                <h3 class="cert-desc-title">Title: One-Day Workshop on Artificial Intelligence</h3>
                <div class="cert-desc-authority">Authority: CodeBind Technologies • 2026</div>
                <p class="cert-desc-text">Note: Evaluation of foundational transformer models, automated agent logic structures, and real-time processing optimization arrays within modern AI ecosystem wrappers.</p>
            </div>
        </div>
