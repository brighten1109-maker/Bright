...
<body>
    ...
    <div class="portfolio-canvas">
        ...
        <div class="cert-header-area">
            <h1 class="cert-title">Flask Python <br>Certificate</h1>
            <div class="cert-subtitle">Sputnik Infotech • 2024</div>
        </div>

        <div class="cert-image-container">
            <img src="img/c5.jpeg" alt="AWS Solutions Architect Certificate Asset" class="art-image-backdrop">
        </div>

        <div class="cert-description-area">
            <div class="interactive-text-block">
                <h3 class="cert-desc-title">Title: Internship Completion Certificate</h3>
                <div class="cert-desc-authority">Authority: Sputnik Infotech • 2024</div>
                <p class="cert-desc-text">Note: Acquired practical skills in FLASK PYTHON during a one-month internship training program.</p>
            </div>
        </div>
