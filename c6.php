...
<body>
    ...
    <div class="portfolio-canvas">
        ...
        <div class="cert-header-area">
            <h1 class="cert-title">NPTEL online<br>Certificate</h1>
            <div class="cert-subtitle">MOOC - India • 2026</div>
        </div>

        <div class="cert-image-container">
            <img src="img/c8.jpeg" alt="NPTEL Soft Skill Development Certificate Asset" class="art-image-backdrop">
        </div>

        <div class="cert-description-area">
            <div class="interactive-text-block">
                <h3 class="cert-desc-title">Title: Soft Skill Development (Elite Certification)</h3>
                <div class="cert-desc-authority">Authority: IIT Kharagpur (NPTEL) • 2026</div>
                <p class="cert-desc-text">Note: Mastery of strategic organizational behavioral paradigms, high-impact technical communication modeling, resource negotiation tracks, and cross-functional leadership execution.</p>
            </div>
        </div>
