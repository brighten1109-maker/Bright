...
<body>
    ...
    <div class="portfolio-canvas">
        ...
        <div class="cert-header-area">
            <h1 class="cert-title">Internship completion Certificate<br>intern</h1>
            <div class="cert-subtitle">CodeBind Technologies • 2026</div>
        </div>

        <div class="cert-image-container">
            <img src="img/c1.jpeg" alt="Python with AI & ML Certificate Asset" class="art-image-backdrop">
        </div>

        <div class="cert-description-area">
            <div class="interactive-text-block">
                <h3 class="cert-desc-title">Title: Python with Artificial Intelligence & Machine Learning</h3>
                <div class="cert-desc-authority">Authority: CodeBind Technologies • 2026</div>
                <p class="cert-desc-text">Note: Practical application of predictive modeling frameworks, machine learning lifecycle design, and intelligent algorithm scaling leveraging core Python data structures and neural network configurations.</p>
            </div>
        </div>
