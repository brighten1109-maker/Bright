...
<body>
    ...
    <div class="portfolio-canvas">
        ...
        <div class="cert-header-area">
            <h1 class="cert-title">Inplant training<br>Certificate</h1>
            <div class="cert-subtitle">CodeBind technologies • 2026</div>
        </div>

        <div class="cert-image-container">
            <img src="img/c6.jpeg" alt="Python AI & ML System Topologies Certificate Asset" class="art-image-backdrop">
        </div>

        <div class="cert-description-area">
            <div class="interactive-text-block">
                <h3 class="cert-desc-title">Title: Python AI & ML System Topologies</h3>
                <div class="cert-desc-authority">Authority: CodeBind Technologies • 2026</div>
                <p class="cert-desc-text">Note: Implementation of advanced statistical learning models, real-time data ingestion pipelines, and algorithmic optimization loops designed for predictive system environments.</p>
            </div>
        </div>
